...
// Define types for the subscription API response
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-white shadow-md rounded-lg p-4 border border-emerald-200">
                                    ...
                                    {currentPlan ? (
                                        <>
                                            <p>
                                                <strong>Plan:</strong> {subscription?.subscription?.subscriptionTier}
                                            </p>
                                            <p>
                                                <strong>Amount:</strong>{" "}
                                                {subscription?.subscription?.planDetails ? (
                                                  <>
                                                    {subscription.subscription.planDetails.currency === 'INR' ? '₹' : '$'}
                                                    {subscription.subscription.planDetails.amount}{" "}
                                                    {subscription.subscription.planDetails.currency}
                                                  </>
                                                ) : (
                                                  <>
                                                    ${currentPlan?.amount || 'N/A'}{" "}
                                ...
                                <div className="bg-white shadow-md rounded-lg p-4 border border-emerald-200">
                                    ...
                                    <button
                                        ...
                                        className={`w-full bg-red-500 text-white py-2 px-4 rounded-md hover:bg-red-600 transition-colors ${unsubscribeMutation.isPending
